...
function IconUser({ className = "", color = "currentColor" }) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M12 12c2.761 0 5-2.239 5-5s-2.239-5-5-5-5 2.239-5 5 2.239 5 5 5Z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M20 22a8 8 0 1 0-16 0" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function IconEyeOff({ className = "", color = "currentColor" }) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M17.94 17.94C16.23 19.22 14.21 20 12 20 5.5 20 2 12.999 2 12c.3-.673 1.22-2.41 2.93-4.06M9.9 4.24C10.57 4.08 11.27 4 12 4c6.5 0 10 7 10 8 0 .34-.39 1.2-1.17 2.28" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
...
function IconArrowDown({ className = "", color = "currentColor" }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <path d="M6 13l6 6 6-6" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function IconArrowUp({ className = "", color = "currentColor" }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <path d="M18 11l-6-6-6 6" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function IconTrendUp({ className = "", color = "currentColor" }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <path d="M14 8h7v7" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function IconHome({ className = "", color = "currentColor" }) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M3 10l9-7 9 7v9a2 2 0 0 1-2 2h-3a2 2 0 0 1-2-2v-4H8v4a2 2 0 0 1-2 2H3z" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
...
function IconQRCode({ className = "", color = "currentColor" }) {
  return (
    <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M3 3h6v6H3V3zM15 3h6v6h-6V3zM3 15h6v6H3v-6zM15 15h3v3h-3v-3zM18 18h3v3h-3v-3zM15 21v-3" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
    ...
    <main className="min-h-dvh bg-[#F3F4F6] text-[#111827] flex flex-col">
      <div className="flex-1 overflow-y-auto">
        ...
        <header className="flex items-center justify-between px-4 pt-4 mb-6">
          ...
          <button onClick={logout} className="text-sm text-[#EF4444] hover:underline">Salir</button>
        </header>
        ...
        <section className="bg-[#009DA1] mx-4 p-6 rounded-2xl mb-6 shadow-lg">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={() => setVisible(v => !v)} className="flex items-center gap-1 text-white/80 text-sm">
              {visible ? <IconEyeOff color="rgba(255,255,255,0.8)" /> : <IconEye color="rgba(255,255,255,0.8)" />}
